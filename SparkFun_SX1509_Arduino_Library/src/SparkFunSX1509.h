...
// Helper functions:
	...
	unsigned long int millisNeon;  
	//unsigned long int millisDefect; 
	...
	unsigned long _previousFlashMillis;
	...
	//byte  sequence = 0;
	//byte  sequence2 =0; 
	const int startSeq[3][35]={
                    {10,10, 20, 20, 240, 20, 40, 20, 100, 20, 20, 20, 260, 80, 20, 240, 60, 160, 20, 240, 20, 1000, 20, 20, 40, 100, 20, 2740, 240, 860, 20, 140, 20, 60,20},
                    {10,10, 10, 10, 20, 10, 40, 20, 240, 20, 20, 20, 260, 80, 20, 240, 80, 160, 20, 360, 20, 1200, 20, 10, 40, 800, 20, 800, 80, 860, 10, 20, 20, 60, 20},
                    {100,10, 200, 2020, 2400, 20, 40, 20, 100, 20, 20, 20, 260, 80, 20, 240, 60, 160, 20, 240, 20, 1000, 20, 20, 40, 100, 20, 2740, 240, 860, 20, 140, 20, 60, 20}
...
// -----------------------------------------------------------------------------
	...
	void blinkStop(byte pin);
	void On(byte pin);
	bool Off(byte pin);
	bool neonOn(byte pin,byte sequence);
	bool neonOff (byte pin);
	bool halogenOn(byte pin,byte fadeIncrement,byte fadeInterval );
	bool halogenOff(byte pin,byte fadeIncrement,byte fadeInterval );
	bool flash(byte pin,unsigned long onDuration, unsigned long offDuration, unsigned long pauseDuration, int pulses, int delay);
